...
describe("Voting", () => {
  ...
  it("initializes candidates and updates candidate count", async () => {
    ...
    const poll = await votingProgram.account.poll.fetch(pollAddress);
    console.log("Updated poll after adding candidates:", poll);
  ...
  it("votes for candidates", async () => {
    ...
    const pinkCandidate = await votingProgram.account.candidate.fetch(pinkAddress);
    console.log("Pink candidate after votes:", pinkCandidate);
    ...
    const blueCandidate = await votingProgram.account.candidate.fetch(blueAddress);
    console.log("Blue candidate after votes:", blueCandidate);
